...
@Composable
fun getHumedSValue(s: String): String {
    var myRef: DatabaseReference = FirebaseDatabase.getInstance().reference
    var humedadSuelo by remember{ mutableStateOf(0)}

    myRef.child("/UsersData/-N5ltsvqedvxYUSP8k1h/products/-N5m9I02pmsdrHPdtD1y/Lecturas/$s").addValueEventListener(object : ValueEventListener {
